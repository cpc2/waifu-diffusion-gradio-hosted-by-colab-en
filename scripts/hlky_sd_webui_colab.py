...
if opt.optimized:
    ...
    model = load_model_from_config(config, "/gdrive/MyDrive/model.ckpt")
...
def get_font(fontsize):
    fonts = ["/usr/share/fonts/truetype/open-sans/OpenSans-Regular.ttf", "./stable-diffusion/DejaVuSans.ttf"]
